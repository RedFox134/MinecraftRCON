...
public class NetRcon
{
     ...
     * @param returnsData Boolean
     * @param receiveTimeout Integer
     * @param sleepTimer Integer
     * @throws IOException 
     */
    public NetRcon(String ip, int port, String password, 
        boolean returnsData, int receiveTimeout, int sleepTimer) 
            throws IOException
    {
        this.port = port;
	...
	// The leading Xs are place holders for out of bounds bytes that
        //will be converted once we get the java bytes for the string
